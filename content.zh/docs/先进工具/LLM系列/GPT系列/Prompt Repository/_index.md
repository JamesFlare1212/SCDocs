...
{{< tabs "Awesome ChatGPT Prompts" >}}
{{< tab "简介" >}}
欢迎来到“[Awesome ChatGPT Prompts](https://github.com/f/awesome-chatgpt-prompts)”存储库！这是一些可以与ChatGPT模型一起使用的提示示例的集合。

ChatGPT模型是OpenAI训练的一种大型语言模型，能够生成类似人类的文本。通过提供提示，它可以生成继续对话或扩展给定提示的响应。

在本存储库中，您将找到可以与ChatGPT一起使用的各种提示。我们鼓励您将自己的提示添加到列表中，并使用ChatGPT生成新的提示。

要开始，请简单地克隆此存储库，并使用[README.md](https://github.com/f/awesome-chatgpt-prompts/blob/main/README.md)文件中的提示作为ChatGPT的输入。您还可以使用此文件中的提示作为创建自己提示的灵感。

我们希望您会发现这些提示有用，并且使用ChatGPT时玩得开心！
{{< /tab >}}

{{< tab "Prompts" >}}
{{< hint warning >}}
最后更新于2023/5/4  
最新内容请去[原仓库](https://github.com/f/awesome-chatgpt-prompts)查看
{{< /hint >}}
...
{{< tab "点评" >}}
属于System Prompt的范畴，辅以Few Shot可能效果更好。
{{< /tab >}}
...
只需按照[README.md](https://github.com/PlexPt/awesome-chatgpt-prompts-zh/blob/main/README.md)文件中的提示输入即可。
{{< /tab >}}

{{< tab "Prompts" >}}
{{< hint warning >}}
最后更新于2023/5/4  
最新内容请去[原仓库](https://github.com/PlexPt/awesome-chatgpt-prompts-zh)查看
{{< /hint >}}
...
> 
> 你不能输出：
> /imagine prompt: A homesick little dog.
> 
> 你必须输出：
...
> 1. 使用markdown格式；  
> 2. 使用unsplash API；  
> 3. 使用" ![image]https://source.unsplash.com/featured/?<已翻译的英文内容>
> 
> 格式回复：
> 
> 1. 不要使用代码块，不要描述其他内容，不要解释；  
> 2. 根据我输入的内容生成对应格式；  
> 
> 第一个输入内容：小狗在沙滩奔跑  
...
{{< tab "点评" >}}
属于System Prompt的范畴，辅以Few Shot可能效果更好。
[Awesome ChatGPT Prompts](https://github.com/f/awesome-chatgpt-prompts)的汉化版，广告有点多。
{{< /tab >}}
